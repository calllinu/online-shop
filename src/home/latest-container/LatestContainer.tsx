    ...
    <Row gutter={[0, 30]}>
      <Row gutter={[0, 10]} className={styles.mainContainer}>
        ...
        >
          ...
          <Col className={styles.centerContainer}>Get US $10 off with a new supplier</Col>
          <Col className={styles.bottomContainer}>Send quotes with supplier preferences</Col>
        </Col>
      </Row>
    </Row>
  );
